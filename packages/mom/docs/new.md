...
import type { MomCustomTool, ToolAPI } from "@earendil-works/pi-mom";
...
Tools are loaded via jiti. They can import any 3rd party dependencies (install in the tool directory). Imports of `@earendil-works/pi-ai` and `@earendil-works/pi-mom` are aliased to the running mom bundle.
